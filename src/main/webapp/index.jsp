...
<body>
	...
	<div class="container" id="container">
		...
		<% if (request.getAttribute("RegisterErrorMessage") == null && request.getAttribute("LoginErrorMessage") == null) {%>
			...
			<div class="col-md-4">
				<center>
					<div class="card"
						...
						<div id="loginAccount">
							<h2 style="color: white;" id="headings"> Hi !<br /> Welcome To Liminals!<br /> Login Account</h2>
						</div>
						<div class="card-body">
							<form action="<%="http://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/LoginPlayer"%>" method="post">
								<div class="input-group">
									<input class="form-control" type="text" name="username"	placeholder="Username" style="background-color: #1d1515a1">
								</div>
								<div class="input=group">
									<input class="form-control" type="password" name="password" placeholder="Password" style="background-color: #1d1515a1;">
								</div>
								<div class="input=group">
									<input class="form-control" type="hidden" name="serviceUrl" value=<%=serviceUrl%> style="background-color: #1d1515a1;">
								</div>
								<div class="input=group">
									<input class="form-control" type="submit" value="Login" style="background-color: #1d1515a1;">
								</div>
							</form>
						</div>
				</center>
			...
			<div class="col-md-4">
				<div class="card" style="background-color: #ffffff21; padding-top: 300px;">
					...
					<div class="card-body">
						<center>
							<form action="<%="http://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath()	+ "/RegisterPlayer"%>" method="post">
								<div class="input-group">
									<input class="form-control" type="text" name="username"	placeholder="Username" style="background-color: #0c0909c9;">
								</div>
								<div class="input-group">
									<input class="form-control" type="password" name="password" placeholder="Password" style="background-color: #0c0909c9;">
								</div>
								<div class="input-group">
									<input class="form-control" type="password" placeholder="confirm password" name="verify" style="background-color: #0c0909c9;">
								</div>
								<div class="input-group">
									<input class="form-control" type="hidden" name="serviceUrl" value=<%=serviceUrl%>>
								</div>
								<div class="input-group">
									<input class="form-control" type="submit" value="Register" style="background-color: #0c0909c9;">
								</div>
							</form>
						</center>
					</div>
